...
import { User, Mail, Phone, MapPin, Edit, Save, X, Calendar, Shield, Settings, BarChart3 } from 'lucide-react';
      ...
      <div className="profile-container">
        <div className="profile-header admin-header">
          ...
          <div className="profile-title">
            ...
            <p className="profile-role admin-role">
              <Shield size={16} />
              Administrator
            </p>
          </div>
          {!isEditing && (
            <button 
              className="btn-edit admin-edit-btn"
        ...
        {isEditing ? (
          <form className="profile-form" onSubmit={handleSubmit}>
            ...
            <div className="form-actions">
              ...
              <button
                type="submit"
                className="btn-save admin-save-btn"
                disabled={loading}
              >
                <Save size={18} />
          ...
          <div className="profile-info">
            ...
            <div className="password-section">
              ...
              {!showPasswordForm ? (
                <button
                  className="btn-change-password admin-password-btn"
